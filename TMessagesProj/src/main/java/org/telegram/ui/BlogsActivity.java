...
import org.telegram.ui.Adapters.BlogsAdapter;
...
public class BlogsActivity  extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {

    private BlogsAdapter listViewAdapter;
    ...
    private BlogsActivity.ContactsActivityDelegate delegate;
    ...
    public interface ContactsActivityDelegate {
        void didSelectContact(TLRPC.User user, String param, BlogsActivity activity);
    }

    public BlogsActivity(Bundle args) {
        super(args);
    }
    ...
    public View createView(Context context) {
        ...
        listViewAdapter = new BlogsAdapter(context, onlyUsers ? 1 : 0, needPhonebook, ignoreUsers, inviteViaLink, hasGps) {
            @Override
                ...
                if (object instanceof TLRPC.User) {
                    ...
                    if (returnAsResult) {
                        ...
                        if (createSecretChat) {
                            ...
                            if (getMessagesController().checkCanOpenChat(args, BlogsActivity.this)) {
                    ...
                    if (!str.equals("section")) {
                        NewContactBottomSheet activity = new NewContactBottomSheet(BlogsActivity.this, getContext());
                    ...
                    AlertsCreator.createContactInviteDialog(BlogsActivity.this, contact.first_name, contact.last_name, contact.phones.get(0));
                }
            } else {
                ...
                if ((!onlyUsers || inviteViaLink != 0) && section == 0) {
                    if (needPhonebook) {
                        ...
                        if (row == 0) {
                            ...
                            presentFragment(new BlogsActivity(args), false);
                        } else if (row == 2) {
        ...
        if (!createSecretChat && !returnAsResult) {
            ...
            floatingButtonContainer.setOnClickListener(v -> {
                ...
                new NewContactBottomSheet(BlogsActivity.this, getContext()) {
                    @Override
    ...
    public void setDelegate(BlogsActivity.ContactsActivityDelegate delegate) {
